...
import static com.ximmerse.input.ControllerInput.BUTTON_RIGHT_THUMB_DOWN;
import static com.ximmerse.input.ControllerInput.BUTTON_RIGHT_THUMB_LEFT;
import static com.ximmerse.input.ControllerInput.BUTTON_RIGHT_THUMB_RIGHT;
import static com.ximmerse.input.ControllerInput.BUTTON_RIGHT_THUMB_UP;
  ...
  protected int handleControllerRight;
   ...
   /*  if(logLevel < LogCatHelper.OFF) {
    ...
    protected Runnable updateUI = new Runnable() {
        ...
        Log.e(TAG,"start:"+mControllerInputLeft.getButtonDown(BUTTON_START&(~(BUTTON_RIGHT_THUMB_UP|
